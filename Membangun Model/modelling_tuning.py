...
# DagsHub
import os
os.environ['MLFLOW_TRACKING_USERNAME'] = 'jihankusumawwardhani'
os.environ['MLFLOW_TRACKING_PASSWORD'] = '-'

dagshub.init(repo_owner='jihankusumawwardhani', repo_name='my-first-repo', mlflow=True)

# Set experiment dengan error handling
try:
    mlflow.set_experiment("Insurance_Cost_Prediction_Tuning")
except:
    # Kalau gagal, pakai default experiment
    pass
